...
--    add_log('patches_pk: Unknown key value'||                                                                                                       
...
BEGIN                                                                                                                                                 
  ...
  if l_patches.patch_id is not null then                                                                                                              
    ...
    l_patches := patches_tapi.patches_pk(                                                                                                             
...
--     add_log('get_current_rec: Unknown key value'||                                                                                                 
--[FOREACH]pkycol[between]||                                                                                                                          
--    ' [colname/l]='||l_patches.[colname/l]                                                                                                          
--[ENDFOREACH]                                                                                                                                        
--     );                                                                                                                                             
...
BEGIN                                                                                                                                                 
  ...
  UPDATE patches SET ROW = io_patches                                                                                                                 
       WHERE patch_id = io_patches.patch_id                                                                                                           
  RETURNING                                                                                                                                           
     patch_id                                                                                                                                         
    ,patch_name                                                                                                                                       
    ,patch_type                                                                                                                                       
...
EXCEPTION                                                                                                                                             
  WHEN x_unknown_key THEN                                                                                                                             
--    add_log('patches_uk1: Unknown key value'||                                                                                                      
--[FOREACH]uindcol[between]||                                                                                                                         
...
BEGIN                                                                                                                                                 
  ...
  DELETE patches                                                                                                                                      
     WHERE patch_id = i_patches.patch_id                                                                                                              
  ;                                                                                                                                                   
...
BEGIN                                                                                                                                                 
  ...
  EXCEPTION                                                                                                                                           
    WHEN DUP_VAL_ON_INDEX THEN                                                                                                                        
      ...
      io_patches.patch_id := get_current_rec( i_patches =>  io_patches                                                                                
                                                  ,i_raise_error =>  'Y').patch_id;                                                                   
